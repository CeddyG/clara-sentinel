    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="box box-info">	
                ...
                <div class="box-body"> 
                    @if(isset($oItem))
                        {!! BootForm::open()->action( route('admin.contact-category.update', $oItem->id_contact_category) )->put() !!}
                        {!! BootForm::bind($oItem) !!}
                    @else
                        {!! BootForm::open()->action( route('admin.contact-category.store') )->post() !!}
                    @endif

                    {!! BootForm::text(trans('clara-contact::contact-category.name_contact_category'), 'name_contact_category') !!}
