        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <table id="tab-admin" class="table no-margin table-bordered table-hover">
                    ...
                    <tr>
                        <th>ID</th>
                        <th>{{ __('clara-contact::contact.fk_users') }}</th>
                        <th>{{ __('clara-contact::contact.fk_contact_category') }}</th>
                        <th>{{ __('clara-contact::contact.subject_contact') }}</th>
                        <th></th>
                        <th></th>
                    </tr>
                    </thead>
                ...
                columns: [
                    ...
                    { 'data': 'subject_contact' },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = "{!! Button::success('Voir')->asLinkTo(route('admin.contact.show', 'dummyId'))->extraSmall()->block()->render() !!}";
                    ...
                    },
                    {
                        ...
                        "render": function ( data, type, row, meta ) {
                            ...
                            var render = '{!! BootForm::open()->action( route("admin.contact.destroy", "dummyId") )->attribute("onsubmit", "return confirm(\'Vraiment supprimer cet objet ?\')")->delete() !!}'
